...
class click_bell(Base_Task):
    ...
    def load_actors(self):
        ...
        self.add_contact_marker_to_bell()  
        self.scene.step()    
        self.scene.update_render()            
  
    def add_contact_marker_to_bell(self):    
        """Attach a bright colored sphere to the bell's contact point"""    
        if not hasattr(self, 'bell'):    
            return    
          
        # Get contact point position relative to bell    
        contact_point_local = self.bell.get_contact_point(0, "pose").p  
        ...
        builder.add_sphere_visual(    
            radius=0.025,  # 5mm radius (small marker)    
        ...
        # Build and attach to bell    
        marker = builder.build(name="contact_marker")    
        
        # Set marker pose relative to bell    
    ...
    def _update_render(self):    
        ...
        # Update marker to follow bell    
        if hasattr(self, 'contact_marker') and hasattr(self, 'bell'):    
            contact_point_local = self.bell.get_contact_point(0, "pose").p  
            marker_pose = sapien.Pose(p=contact_point_local)    
